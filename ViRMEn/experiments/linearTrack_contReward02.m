...
n = 1;
rProb =         [0, 0.4286 0.1429 0.2857 0 0.7143 0.8571 0.5714 1.0000]';
requiresLick =  [0, 0 0 0 0 0 0 0 0]';
...
n = 2;
rProb =         [0, 0.5714    0.1429    1.0000    0.4286    0.8571         0    0.7143    0.2857]';
requiresLick =  [0, 0 0 0 0 0 0 0 0]';
pProb = [0 0.1429  0.0714  0  0.1072  0.2143 0.1786 0.2500 0.0357];
...
n = 3;
rProb =         [0  0.8571    1.0000    0.1429    0.2857    0.7143    0.5714    0.4286   0]';
requiresLick =  [0 0 0 0 0 0 0 0 0]';
pProb = [0 0.2143 0.0357    0.2500         0    0.1429    0.1786    0.1072    0.0714];
