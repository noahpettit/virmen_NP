function code = tAlternating_v2_phase00
...
if vr.trialEnded
    ...
    if sum([vr.trial(:).twoTowerTrial])>20 && mean([vr.trial([vr.trial(:).twoTowerTrial]==1).isCorrect])>0.60
    ...
    if rand(1)>(max(0, (percentageCorrectLast20 - 0.75))*2)
