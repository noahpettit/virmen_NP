function [vr] = initializePathVIRMEN(vr,rigID)
...
vr.mouseNum = str2double(vr.exper.variables.mouseNumber);  %double
%delete variable mouseNum
vr.exper.variables.mouseNumber = sprintf('%03d',vr.mouseNum); %char, save mouse num in exper 

%path information PP
% path = ['\\research.files.med.harvard.edu\Neurobio\HarveyLab\Paola\DATA\Current Mice\' vr.experimenter sprintf('%03d',vr.mouseNum)];
% tempPath = '\\research.files.med.harvard.edu\Neurobio\HarveyLab\Paola\DATA\Temporary';
% path info NP
