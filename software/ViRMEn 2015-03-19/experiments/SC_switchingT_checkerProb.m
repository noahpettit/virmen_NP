function code = SC_switchingT_checkerProb
...
vr.penaltyITI = 2;
vr.penaltyProb = 1;
vr.noCheckerFraction = eval(vr.exper.variables.noCheckerFraction);
...
if vr.inITI == 0 && abs(vr.position(1)) > vr.armLength/2 + 10;
    ...
    || vr.currentWorld==5 || vr.currentWorld==8;
...
if rand(1) < vr.noCheckerFraction
    worlds = worlds + 4;
end
