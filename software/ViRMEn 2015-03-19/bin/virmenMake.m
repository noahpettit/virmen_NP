            ...
            for attempts = 1:3
                try
                    ...
                    elseif strcmp(computer, 'MACI64')
                        mex('-L./GLFW','-lglfw3','LDFLAGS="\$LDFLAGS','-framework','Cocoa','-framework','OpenGL','-framework','IOKit','-framework','CoreVideo"','-outdir',currentDir,f);
                    else
                        if wasCopied == true
                            delete(f);
                        end
